...
description: "OpenSIN macht aus opensin vs code extension v0.1.0 — dein editor wird zum agenten-command-center einen klareren, schnelleren Workflow mit weniger manuellem Aufwand."
date: 2026-04-04
author: OpenSIN Team
...
> **Warum das zählt:** OpenSIN VS Code Extension v0.1.0 — Dein Editor wird zum Agenten-Command-Center zeigt, wie OpenSIN Arbeit nicht nur unterstützt, sondern spürbar vereinfacht.
>
...
Die Extension bringt **5 spezialisierte Modi** mit — inspiriert von den besten Konzepten aus Kilo Code und OpenCode, aber mit dem entscheidenden Unterschied: **Jeder Modus ist ein spezialisierter Agent, kein generischer Chat.**
...
Seien wir ehrlich: **OpenCode und Kilo Code haben großartige Ideen.** Aber sie haben auch fundamentale Schwächen.

### Von OpenCode genommen:
- ✅ **Inline Chat** — Code im Kontext diskutieren
- ✅ **Code Actions** — Rechtsklick-Integration
- ✅ **Proaktive Vorschläge** — Hintergrundanalyse

**Aber OpenCode kann nur:** EIN Modell. EIN Agent. EINS zu EINS.
...
```
OpenCode:  1 Prompt → 1 Antwort → Du machst weiter
...
- `SIN.md` — Kompatibilität mit OpenCode Projekten
